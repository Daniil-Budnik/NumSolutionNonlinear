import logging as lg                                            # Логирование (для отладки ошибок)
...
def Det(M,Method="default"):
    ...
    def _Det_Triangle(M):
        ...
        for i in range(L):                                      # Проверка необходимого условия
            if(M[i][i] == 0):                                   # Если на главной линии есть 0, то ошибка
                lg.error("\t <Det><_Det_Triangle> \t Ошибка нахождения определителя: на главной линии присутствует 0!!!")
    ...
    # Случай с n-мерной матрицей
        ...
        if(Method == "default"):    return _Det_(M)
        if(Method == "triangle"):   return _Det_Triangle(M)
        else:
